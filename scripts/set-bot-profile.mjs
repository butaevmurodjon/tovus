...
const description = `Добавьте меня в группу администратором — буду автоматически удалять нецензурную лексику, рекламный спам (ссылки на посторонние каналы/боты, «пишите в ЛС», флуд) и скам: фейковые .apk «приложения банка», фишинговые ссылки, аккаунты из базы известных спамеров (CAS).
