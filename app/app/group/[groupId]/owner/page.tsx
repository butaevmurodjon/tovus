      ...
      <Card>
        <CardSection title="Ежедневная ИИ-сводка чата">
          <p className="text-[12px] mb-3" style={{ color: "var(--ink-muted)" }}>
            Owner-only (ROADMAP §7.3, 2026-09-14 re-cut) — у группы больше нет своего тумблера, решение целиком здесь. Текст переписки за день уходит во внешний сервис (DeepSeek), а сама сводка + статистика дня приходят не в эту группу, а отдельным сообщением в хаб-супергруппу (своя тема на группу) — настраивается через DIGEST_HUB_CHAT_ID.
          </p>
