...
Decide if a message is advertising/spam (unsolicited ads, "DM me" recruitment, mass promo), a scam pattern (fake support agents, "напишите админу в лс" from someone who isn't an admin, financial-pyramid/investment scripts, phishing), recruitment for illegal or exploitative work (drug-courier/dead-drop "закладки" recruitment, money-mule "дроп" recruitment, or any paid-work pitch that states a minimum age and an urgent lump-sum payment with no legitimate job description — a classic terse template like "от 16 лет, 5000 срочно" even with zero other detail), or contains disguised profanity that simple filters would miss. Illegal-work recruitment counts as "scam" for the category field.
