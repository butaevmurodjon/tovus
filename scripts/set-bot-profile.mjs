...
const shortDescription =
  "Антиспам и анти-скам бот-модератор: чистит мат, рекламу, скам и вирусные .apk. Настройки — в Mini App.";

// Telegram caps setMyDescription at 512 characters — keep this tight.
const description = `Добавьте меня в группу администратором — буду удалять мат, рекламный спам, скам (фейковые .apk, фишинг) и проверять новичков по базе спамеров CAS.

Базовый фильтр бесплатный; премиум-режим на ИИ (DeepSeek) — для спорных случаев. Настройки — командами в чате или в панели управления (Mini App).
...
const commandsRu = [
  ...
  { command: "captchatype", description: "Тип капчи: button/math/rules/message" },
  ...
  { command: "joinrequestcaptcha", description: "Капча перед одобрением заявки на вступление: on/off" },
...
const commandsUz = [
  ...
  { command: "captchatype", description: "Капча тури: button/math/rules/message" },
  ...
  { command: "joinrequestcaptcha", description: "Аъзоликка сўровни тасдиқлашдан олдин капча: on/off" },
  { command: "stats", description: "Статистика: today/7d/30d" },
